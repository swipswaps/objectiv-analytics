...
def _get_event_data(request: Request) -> EventList:
    ...
    :raise ValueError:
        ...
        5) there are more than DATA_MAX_EVENT_COUNT events in the event list
        6) the structure did not validate as a valid EventList (validate_structure_event_list()
