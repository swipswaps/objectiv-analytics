...
enable effective feature creation for datasets that embrace the open analytics taxonomy.

To get a taste of what you can do with Objectiv Bach, There is a `demo
</docs/home/quickstart-guide>`_ available that enables you to run the full Objectiv pipeline on your local
machine. It includes our website as a demo app, a Jupyter Notebook
