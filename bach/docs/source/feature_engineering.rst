...
.. code-block:: python
    ...
    import datetime
    features_unstacked['session_duration'] = of.mh.agg.session_duration(groupby='user_id').fillna(datetime.timedelta(0))
