...
from buhtuh.types import TypeRegistry
from buhtuh.series.series_objectiv import BuhTuhSeriesGlobalContexts, BuhTuhSeriesLocationStack
from tests.functional.buhtuh.test_data_and_utils import  get_bt_with_json_data_real, assert_equals_data
...
def test_objectiv_stack_type(monkeypatch):
    ...
    _registry.register_dtype_series(BuhTuhSeriesGlobalContexts, [], override_registered_types=True)
    _registry.register_dtype_series(BuhTuhSeriesLocationStack, [], override_registered_types=True)
