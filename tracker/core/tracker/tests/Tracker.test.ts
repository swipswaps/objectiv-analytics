...
describe('Tracker', () => {
  ...
  it('should instantiate with another Tracker, inheriting its state, yet being independent instances', () => {
    const initialContextsState: ContextsConfig = {
      ...
      globalContexts: [
        { _global: true, _context_type: 'global', id: 'A' },
        { _global: true, _context_type: 'global', id: 'B' },
      ],
    };
    ...
    newTestTracker.locationStack.push({ _location: true, _context_type: 'section', id: 'X' });
    ...
    expect(newTestTracker.locationStack).toEqual([
      { _location: true, _context_type: 'section', id: 'root' },
      { _location: true, _context_type: 'section', id: 'A' },
      { _location: true, _context_type: 'section', id: 'X' },
    ]);
  ...
  it('should allow complex compositions of multiple Tracker instances and Configs', () => {
    const mainTrackerContexts: ContextsConfig = {
      ...
      globalContexts: [
        { _global: true, _context_type: 'global', id: 'X' },
        { _global: true, _context_type: 'global', id: 'Y' },
      ],
    };
    ...
    const sectionTracker = new Tracker(
      mainTracker,
      {
        locationStack: [{ _location: true, _context_type: 'section', id: 'B' }],
        globalContexts: [{ _global: true, _context_type: 'global', id: 'Z' }],
      },
      {
        locationStack: [{ _location: true, _context_type: 'section', id: 'C' }],
      },
    ...
    expect(sectionTracker.globalContexts).toEqual([
      { _global: true, _context_type: 'global', id: 'X' },
      { _global: true, _context_type: 'global', id: 'Y' },
      { _global: true, _context_type: 'global', id: 'Z' },
    ]);
  });
  ...
  describe('trackEvent', () => {
    const eventContexts: ContextsConfig = {
      locationStack: [
        { _location: true, _context_type: 'section', id: 'B' },
        { _location: true, _context_type: 'item', id: 'C' },
      ],
      globalContexts: [
        { _global: true, _context_type: 'global', id: 'W' },
        { _global: true, _context_type: 'global', id: 'X' },
      ],
    };
