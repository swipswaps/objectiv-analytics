 ...
 */
export const makeApplicationContext = ( props: { id: string }): 
    ApplicationContext => ({
 ...
 */
export const makeContentContext = ( props: { id: string }): 
    ContentContext => ({
 ...
 */
export const makeCookieIdContext = ( props: { id: string; cookie_id: string }): 
    CookieIdContext => ({
	__global_context: true,
 ...
 */
export const makeExpandableContext = ( props: { id: string }): 
    ExpandableContext => ({
	__location_context: true,
 ...
 */
export const makeHttpContext = ( props: { id: string; referrer: string; user_agent: string; remote_address: string }): 
    HttpContext => ({
	__global_context: true,
	_type: 'HttpContext',
	id: props.id ,
 ...
 */
export const makeInputContext = ( props: { id: string }): 
    InputContext => ({
	__location_context: true,
	_type: 'InputContext',
	id: props.id ,
 ...
 */
export const makeLinkContext = ( props: { id: string; href: string }): 
    LinkContext => ({
	__location_context: true,
...
/** Creates instance of MarketingContext 
  ...
  * @param {string | null} props.term - Search keywords
  * @param {string | null} props.content - Used to differentiate similar content, or links within the same ad
 ...
 */
export const makeMarketingContext = ( props: { id: string; source: string; medium: string; campaign: string; term?: string | null; content?: string | null }): 
    MarketingContext => ({
	__global_context: true,
 ...
 */
export const makeMediaPlayerContext = ( props: { id: string }): 
    MediaPlayerContext => ({
	__location_context: true,
 ...
 */
export const makeNavigationContext = ( props: { id: string }): 
    NavigationContext => ({
	__location_context: true,
...
/** Creates instance of OverlayContext 
  ...
  * 	.
 */
export const makeOverlayContext = ( props: { id: string }): 
    OverlayContext => ({
	__location_context: true,
 ...
 */
export const makePathContext = ( props: { id: string }): 
    PathContext => ({
	__global_context: true,
	_type: 'PathContext',
	id: props.id ,
 ...
 */
export const makePressableContext = ( props: { id: string }): 
    PressableContext => ({
	__location_context: true,
	__pressable_context: true,
 ...
 */
export const makeRootLocationContext = ( props: { id: string }): 
    RootLocationContext => ({
	__location_context: true,
 ...
 */
export const makeSessionContext = ( props: { id: string; hit_number: number }): 
    SessionContext => ({
	__global_context: true,
