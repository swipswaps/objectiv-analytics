...
rod_df = full_df[full_df.global_contexts.gc.application == 'rod-web-demo']
feature_df = FeatureFrame.from_data_frame(df=rod_df, location_stack_column='location_stack',
